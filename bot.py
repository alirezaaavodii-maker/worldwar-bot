...
# ------------------------------------------------------------------
# کشورهای اصلی (با جزئیات کامل و آیتم امضادار)
# ------------------------------------------------------------------
COUNTRIES = {
    ...
    "israel":      {"name": "اسرائیل 🇮🇱", "region": "middle_east", "population": "~۹.۵ میلیون",
                     "start_gold": 28000, "bonus": "air_discount", "value": 0.75, "desc": "تجهیزات هوایی ۲۵٪ ارزان‌تر",
                     "signature": ["defense_ironbeam", "drone_hermes"], "faction": "موساد",
                     "equipment_info": [("پدافند آیرون‌بیم", "چندین سامانه")]},
    ...
    "iraq":        {"name": "عراق 🇮🇶", "region": "middle_east", "population": "~۴۵ میلیون",
                     "start_gold": 18000, "bonus": "oil_mult", "value": 1.4, "desc": "درآمد نفت +۴۰٪",
                     "signature": [], "faction": None, "equipment_info": [("تجهیزات متنوع زمینی", "متوسط")]},
    "uae":         {"name": "امارات متحده 🇦🇪", "region": "middle_east", "population": "~۱۰ میلیون",
    ...
    "qatar":       {"name": "قطر 🇶🇦", "region": "middle_east", "population": "~۳ میلیون",
                     "start_gold": 30000, "bonus": "oil_mult", "value": 1.5, "desc": "درآمد نفت +۵۰٪",
                     "signature": [], "faction": None, "equipment_info": [("پدافند پاتریوت", "چند سامانه")]},
    ...
    "italy":       {"name": "ایتالیا 🇮🇹", "region": "europe", "population": "~۵۹ میلیون",
    ...
    "spain":       {"name": "اسپانیا 🇪🇸", "region": "europe", "population": "~۴۸ میلیون",
    ...
    "poland":      {"name": "لهستان 🇵🇱", "region": "europe", "population": "~۳۷ میلیون",
    ...
    "ukraine":     {"name": "اوکراین 🇺🇦", "region": "europe", "population": "~۳۶ میلیون",
                     "start_gold": 18000, "bonus": "land_discount", "value": 0.75, "desc": "تجهیزات زمینی ۲۵٪ ارزان‌تر",
                     "signature": ["drone_bayraktar"], "faction": None, "equipment_info": [("پهباد ضدزره", "متعدد")]},
    ...
    "japan":       {"name": "ژاپن 🇯🇵", "region": "east_asia", "population": "~۱۲۳ میلیون",
                     "start_gold": 34000, "bonus": "sea_discount", "value": 0.75, "desc": "تجهیزات دریایی ۲۵٪ ارزان‌تر",
                     "signature": ["destroyer_kongo", "fighter_f35"], "faction": None,
                     "equipment_info": [("ناوشکن کونگو", "چند فروند")]},
    "south_korea": {"name": "کره جنوبی 🇰🇷", "region": "east_asia", "population": "~۵۲ میلیون",
                     "start_gold": 27000, "bonus": "land_discount", "value": 0.8, "desc": "تجهیزات زمینی ۲۰٪ ارزان‌تر",
                     "signature": ["tank_k2"], "faction": None, "equipment_info": [("تانک کی-۲", "صدها دستگاه")]},
    "vietnam":     {"name": "ویتنام 🇻🇳", "region": "east_asia", "population": "~۹۹ میلیون",
                     "start_gold": 16000, "bonus": "land_discount", "value": 0.8, "desc": "تجهیزات زمینی ۲۰٪ ارزان‌تر",
                     "signature": [], "faction": None, "equipment_info": [("تجهیزات زمینی سبک", "متوسط")]},
    "indonesia":   {"name": "اندونزی 🇮🇩", "region": "east_asia", "population": "~۲۸۰ میلیون",
    ...
    "pakistan":    {"name": "پاکستان 🇵🇰", "region": "central_asia", "population": "~۲۴۰ میلیون",
                     "start_gold": 17000, "bonus": "uranium_mult", "value": 1.3, "desc": "درآمد اورانیوم +۳۰٪",
                     "signature": ["missile_shaheen"], "faction": None, "equipment_info": [("موشک شاهین", "چند ده فروند")]},
    "afghanistan": {"name": "افغانستان 🇦🇫", "region": "central_asia", "population": "~۴۰ میلیون",
                     "start_gold": 10000, "bonus": "land_discount", "value": 0.7, "desc": "تجهیزات زمینی ۳۰٪ ارزان‌تر",
                     "signature": [], "faction": None, "equipment_info": [("تجهیزات سبک زمینی", "پراکنده")]},
    ...
    "canada":      {"name": "کانادا 🇨🇦", "region": "north_america", "population": "~۳۹ میلیون",
    ...
    "mexico":      {"name": "مکزیک 🇲🇽", "region": "north_america", "population": "~۱۲۹ میلیون",
                     "start_gold": 16000, "bonus": "gold_mult", "value": 1.2, "desc": "درآمد دلار +۲۰٪",
                     "signature": [], "faction": None, "equipment_info": [("تجهیزات زمینی سبک", "متوسط")]},
    ...
    "argentina":   {"name": "آرژانتین 🇦🇷", "region": "south_america", "population": "~۴۶ میلیون",
                     "start_gold": 16000, "bonus": "gold_mult", "value": 1.2, "desc": "درآمد دلار +۲۰٪",
                     "signature": [], "faction": None, "equipment_info": [("تجهیزات زمینی سبک", "متوسط")]},
    "australia":   {"name": "استرالیا 🇦🇺", "region": "oceania", "population": "~۲۶ میلیون",
                     "start_gold": 29000, "bonus": "sea_discount", "value": 0.85, "desc": "تجهیزات دریایی ۱۵٪ ارزان‌تر",
                     "signature": [], "faction": None, "equipment_info": [("ناوشکن مدرن", "چند فروند")]},
}

# ------------------------------------------------------------------
# بقیه‌ی اعضای ناتو و بریکس (تا جولای ۲۰۲۶) — به‌صورت خودکار اضافه میشن
# ------------------------------------------------------------------
_EXTRA_NATO_BRICS = [
...
for _key, _name, _region, _bonus, _value, _desc, _pop in _EXTRA_NATO_BRICS:
    COUNTRIES[_key] = {
        "name": _name, "region": _region, "population": _pop,
        "start_gold": 20000, "bonus": _bonus, "value": _value, "desc": _desc,
        "signature": [], "faction": None,
        "equipment_info": [("تجهیزات استاندارد عضو ناتو/بریکس", "متوسط تا خوب")],
    }
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "این یه بازی استراتژیک زنده‌ست با بیش از ۵۰ کشور واقعی از اعضای ناتو و بریکس. کشورت رو اداره می‌کنی، اقتصادت رو می‌سازی، ارتش تشکیل می‌دی و با بقیه‌ی بازیکن‌ها وارد جنگ، جاسوسی و دیپلماسی میشی.\n\n"
...
async def trade_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    lines.append("")
    lines.append("یکی از گزینه‌های پایین رو بزن، یا برای انتقال به بازیکن دیگه: /send <username> <resource> <تعداد>")
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "📖 راهنمای کامل بازی:\n\n"
        "/start — ثبت‌نام (قاره → کشور، بیش از ۵۰ کشور واقعی از ناتو و